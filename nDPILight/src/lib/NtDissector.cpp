...
int NtDissector::newFlow(int proto) 
{
    std::cout << "New flow\n";
    ...
    NtDyn1Descr_t* dyn1 = _NT_NET_GET_PKT_DESCR_PTR_DYN1(hNetBuffer);
    uint8_t* packet = reinterpret_cast<uint8_t*>(dyn1) + dyn1->descrLength;
